class MainsController < ApplicationController
  def index
    ...
    @playlist = { station: Station.fake(title: 'Todays Most Listened'), songs: Song.playlist_most_listened(within: 1.day, limit: 10), classname: 'show-count', dont_paginate: true, already_limited: true, nocache: true }
